                    ...
                    <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-16">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        id="name"
                                        required
                                        className="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-3 px-4 focus:ring-yellow-500 focus:border-yellow-500 transition duration-150"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        name="subject"
                                        required
                                        className="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-3 px-4 focus:ring-yellow-500 focus:border-yellow-500 transition duration-150 bg-white"
                                    >
                        ...
                        <div className="space-y-10">
                            ...
                            <div className="flex items-start">
                                <span className="flex-shrink-0 p-3 rounded-full bg-yellow-100 text-yellow-600">
