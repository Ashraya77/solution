    ...
    return (
        <>
            ...
            <footer className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-[#5524B7] to-[#380B60] text-white/70">
                <h1 className="text-3xl font-extrabold">Solution Computer House</h1>
                <p className="mt-4 text-center">Copyright © 2025 <a href="https://prebuiltui.com">Solution Computer House</a>. All rights reservered.</p>
