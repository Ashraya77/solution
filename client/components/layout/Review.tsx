  ...
  return (
    ...
    >
      <div className="relative mb-12 flex flex-col items-center">
        <h1 className="text-3xl md:text-4xl font-bold text-center text-foreground relative z-10">
          What People Say
        </h1>
        <div className="w-48 md:w-64 mt-1 text-accent">
      ...
      >
        {reviews.map((r) => (
          <SwiperSlide key={r.id}>
            <div className="bg-soft-purple shadow-lg rounded-2xl p-6 text-center flex flex-col items-center min-h-80 justify-between">
              ...
              <div className="mt-6">
                ...
                <h2 className="font-semibold text-foreground text-sm md:text-base">
                  ...
                  <span className="text-muted font-normal">from {r.city}</span>
                </h2>
              </div>
            </div>
          </SwiperSlide>
